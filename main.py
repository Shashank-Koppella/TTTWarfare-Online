...
def menu_screen():
    ...
    while True:
        ...
        button4_x = button_width - 50
        button4_y = screen_height - 50
        pygame.draw.rect(screen, Background_Colour, (button4_x, button4_y, button_width, button_height))
        button4_text = font3.render("How to Play", True, font_color)
        button4_text_rect = button4_text.get_rect(
            center = (button4_x, button4_y))
